...
hist1 = Hist(bin("de_mass",50,0,200))
hist2 = Hist(bin("dm_mass",50,0,200))
...
for arrays in uproot.iterate('root_files/*1.root','Events',columns,entrysteps=10000000000):
	...
	hist1.fill(de_mass=dielectron_mass)
	hist2.fill(dm_mass=dimuon_mass)
beside(		
hist1.step("de_mass"),
